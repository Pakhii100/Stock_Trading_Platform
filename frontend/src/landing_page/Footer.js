...
function Footer() {
     return (
          <footer style={{ backgroundColor: '#ffffffd9' }}>
               <div className="container border-top mt-5 py-3">
                    <div className="row">
                         <div className="col">
                         ...
                         <div className="col">
                              ...
                              <a href="#" style={{ textDecoration: 'none' }} className="text-muted">Referral</a><br></br>
                              <a href="#" style={{ textDecoration: 'none' }} className="text-muted">programme</a><br></br>
                         ...
                         <div className="col">
                              ...
                              <a href="#" style={{ textDecoration: 'none' }} className="text-muted">Support</a><br></br>
                              <a href="#" style={{ textDecoration: 'none' }} className="text-muted">portal</a><br></br>
                              <a href="#" style={{ textDecoration: 'none' }} className="text-muted">Z-Connect</a><br></br>
